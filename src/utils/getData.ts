import * as bmob from './back/bmob';
// import * as leancloud from './back/leancloud';

export const deleteInfo = bmob.deleteInfo;
...
// export const getInfo = leancloud.getInfo;
// export const saveInfo = leancloud.saveInfo;
